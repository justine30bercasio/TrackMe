...
const List<PaymentMethodInfo> paymentMethods = [
  ...
  PaymentMethodInfo(code: 'bpi', label: 'BPI', group: 'bank', brandColor: Color(0xFF1E88E5), monogram: 'BPI', assetIcon: 'assets/payment_methods/bpi.svg'),
  PaymentMethodInfo(code: 'bdo', label: 'BDO', group: 'bank', brandColor: Color(0xFF0F69BA), monogram: 'BDO', assetIcon: 'assets/payment_methods/bdo.svg'),
  ...
  PaymentMethodInfo(code: 'landbank', label: 'Landbank', group: 'bank', brandColor: Color(0xFFE4002B), monogram: 'LBP', assetIcon: 'assets/payment_methods/landbank.svg'),
  PaymentMethodInfo(code: 'pnb', label: 'PNB', group: 'bank', brandColor: Color(0xFFC8102E), monogram: 'PNB', assetIcon: 'assets/payment_methods/pnb.svg'),
  PaymentMethodInfo(code: 'psbank', label: 'PSBank', group: 'bank', brandColor: Color(0xFF00477C), monogram: 'PS', icon: Icons.account_balance),
  PaymentMethodInfo(code: 'chinabank', label: 'China Bank', group: 'bank', brandColor: Color(0xFFD50032), monogram: 'CB', assetIcon: 'assets/payment_methods/chinabank.svg'),
